 ...
 * @endcode
 */
$settings['hash_salt'] = 'Qy-WUrg6NtDHNCGLwvd-EUosY7r86WjoyJF0Y90hZnS6nUr79pfC2OpS-E0NNQEeCDmHao_aMw';
...
$settings['config_sync_directory'] = 'sites/default/files/config_LF7buqxSRWchCD3dEFkiMGG1g7CnIuQCVY2ReT3Nr2Z68n_-Fv7kqF6ShfjCkvBYO_BiycV3RA/sync';

$settings['trusted_host_patterns'] = [
  '^localhost$',
  '^127\.0\.0\.1$',
  '^education.test$',
  '^192.168.0.73',  // Reemplaza con tu IP
];
